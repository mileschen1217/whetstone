#!/usr/bin/env bash
# One second-epic trial: as intent-low-stock, plus RECORDS=none|epic|memory passed to the fixture.
...
out="$1/$3-${RECORDS:-none}-t$2"; model="${EVAL_MODEL:-opus}"; owner="${OWNER_MODEL:-sonnet}"; rounds="${MAX_ROUNDS:-6}"
