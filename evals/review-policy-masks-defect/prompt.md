...
timeout_seconds: 600
tags: [review, rule]
description: "serves — rule: the review ends when both walks are finished, not when a finding exists (a broken rule does not stop the search for wrong behaviour)"
